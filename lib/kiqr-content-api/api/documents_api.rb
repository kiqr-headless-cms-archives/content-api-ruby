...
module Kiqr::ContentApi
  class DocumentsApi
    ...
    # @return [Document]
    def get_document(content_type_id, document_slug, opts = {})
      data, _status_code, _headers = get_document_with_http_info(content_type_id, document_slug, opts)
      data
    end
    ...
    def get_document_with_http_info(content_type_id, document_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && content_type_id.nil?
        fail ArgumentError, "Missing the required parameter 'content_type_id' when calling DocumentsApi.get_document"
      end
      ...
      # resource path
      local_var_path = '/{contentTypeId}/{documentSlug}'.sub('{' + 'contentTypeId' + '}', CGI.escape(content_type_id.to_s)).sub('{' + 'documentSlug' + '}', CGI.escape(document_slug.to_s))
